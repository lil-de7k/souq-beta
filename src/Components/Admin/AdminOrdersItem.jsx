      ...
      <div className='w-full sm:w-[72%] md:w-[76%] px-3 py-2 sm:px-4 sm:py-4 flex flex-col justify-between'>
        ...
        <div>
          <div className='mb-2 mt-2 sm:mt-0'>
            <p className='text-gray-700 font-bold text-[11px] sm:text-[12.5px] '>طلب رقم #11</p>
          </div>
        ...
        {/* الكمية والسعر */}
        <div className='flex justify-between items-center text-[10px] sm:text-sm font-semibold text-gray-800 pb-1 sm:pb-0 mt-0.5 sm:mt-2'>
          <div className='flex gap-2 items-center'>
            <p>الكميه</p>
            <span className='sm:text-[13px] mt-0.5 sm:mt-1'>5</span>
          </div>
          <p>3000 جنيه</p>
        </div>
      </div>
