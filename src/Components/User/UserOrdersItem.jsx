...
const UserOrdersItem = () => {
  return (
    <div className='flex flex-col sm:flex-row border-b border-gray-200 py-1 overflow-hidden'>
      {/* صورة المنتج */}
      <div className='w-full sm:w-[28%] md:w-[24%] flex justify-center border-b sm:border-b-0 sm:border-l border-gray-200 pt-1 sm:pt-0'>
        <img src="/mobile.png" className='w-24 sm:w-24 md:w-26 py-2 object-contain' alt="Product Image" />
      </div>
      ...
      <div className='w-full sm:w-[72%] md:w-[76%] px-3 py-2 sm:px-4 sm:py-4 flex flex-col justify-between'>
        ...
        <div>
          <div className='flex justify-between text-[10.5px] sm:text-[12px] mb-2 mt-2 sm:mt-0'>
            ...
            <div className='flex items-center cursor-pointer hover:opacity-65 transition-all duration-200 ease-in-out font-semibold'>
